...
import { updateTask } from '../store/tasks/facade';
        ...
        <div className="container">
            ...
            <TaskForm
                        onSubmit={(e) => {
                            ...
                            // update task
                            updateTask(task.id, 'name', taskState.name);
                            updateTask(task.id, 'description', taskState.description);
                            updateTask(task.id, 'status', taskState.status);
...
UpdateTask.getInitialProps = async ({ query }) => {
    return {
